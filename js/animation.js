...
// async function createStaticElement(element) {
//   const div = document.createElement('div');
...
//   // Tasodifiy joylashuv
//   const randomX = Math.random() * (window.innerWidth - 100); // 100px (elementning kengligi) dan kam
//   div.style.left = `${randomX}px`;
//   div.style.bottom = '0px'; // Har doim pastda

//   intro.appendChild(div);

//   // Harakatni boshqarish
//   addCursorHoverEffect(div);
// }
...
//     setTimeout(() => createStaticElement(element), index * 300);
//   });
// }

// window.onload = startStaticAnimation;
